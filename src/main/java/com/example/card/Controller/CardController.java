...
public class CardController {
  ...
  public ResponseEntity<List<Card>> getCardByHasAnnualFee(
      @PathVariable("hasAnnualFee") boolean hasAnnualFee) {
  ...
  public ResponseEntity<Card> updateCardByName(
      @PathVariable("name") String name, @RequestBody Card updatedCard) {
    return cardService
        .updateCardByName(name, updatedCard)
        .map(ResponseEntity::ok)
        .orElseGet(() -> ResponseEntity.notFound().build());
  }
}
